    ...
    <div>
      <label class="flex items-center gap-4 text-sm leading-6 text-zinc-600">
        ...
        <input
          ...
          value="true"
          checked={@checked}
          class="rounded border-zinc-300 py-1 px-2 border-1 text-zinc-900 focus:ring-0"
          {@rest}
        />
        {@label}
      </label>
  ...
  def input(assigns) do
    ...
    <div>
      ...
      <input
        ...
        class={[
          "py-1 px-2 border-1 mt-2 block w-full rounded-lg text-zinc-900 focus:ring-0 sm:text-sm sm:leading-6",
          @errors == [] && "border-zinc-300 focus:border-zinc-400",
          @errors != [] && "border-rose-400 focus:border-rose-400"
        ]}
        {@rest}
